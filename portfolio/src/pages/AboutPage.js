...
function AboutPage(props) {
    return (
        <div className="text-center">
            ...
            <AboutMeContent>
                <p>Hi, my name is Xing Yu. I'm a Computer Science student currently studying at NUS with experience in NodeJS, Typescript, mySQL, Telegram API, Google Sheets API and Outsystems.</p>
